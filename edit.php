     ...
     if(!$row){
      ...
      $Email=$row["Email"];
        ...
        do {
            ...
            $sql="UPDATE etudiant SET cin='$cin',Prenom='$Prenom',Nom='$Nom',Email='$Email' 
            WHERE cin=$cin";
            $result = $connection->query($sql);
            ...
            $successMessage="Etudiant modifié correctement";
...
<body>
    <div class="container my-5">
        <h2>Modifier les données d'un étudiant</h2>
        ...
        ?>
        <form method="post">
            <input type="hidden" value="<?php echo $cin ?>">
            <div class="row mb-3">
